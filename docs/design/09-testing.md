...
| `packages/pyodide-terminal/src/`   | `{sinks,rewind-tail,stdin-reader,notice,selection-copy}.test.ts`(repl에서 이동), `terminal-runner.test.ts`(jsdom + 가짜 core), `terminal-runner-screen.test.ts`(jsdom + 실제 core + 공용 가짜 worker `@cp949/runo-pyodide-core/test-utils`), `package-boundary.test.ts`                                                                                                                                                                                                                                                                                                                                                                                                                                |
